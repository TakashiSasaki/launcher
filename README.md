...
No application framework, package manager, Firebase project, deployment target, or production configuration has yet been selected or committed. Agents must not infer these choices from unrelated repositories. Ambiguities must be recorded rather than silently resolved.
